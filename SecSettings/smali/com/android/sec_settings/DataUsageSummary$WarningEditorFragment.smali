.class public Lcom/android/sec_settings/DataUsageSummary$WarningEditorFragment;
...
.method public static show(Lcom/android/sec_settings/DataUsageSummary;)V
    ...
    .line 2113
    new-instance v1, Lcom/android/sec_settings/DataUsageSummary$WarningEditorFragment;

    invoke-direct {v1}, Lcom/android/sec_settings/DataUsageSummary$WarningEditorFragment;-><init>()V

    .line 2114
    .local v1, dialog:Lcom/android/sec_settings/DataUsageSummary$WarningEditorFragment;
    invoke-virtual {v1, v0}, Lcom/android/sec_settings/DataUsageSummary$WarningEditorFragment;->setArguments(Landroid/os/Bundle;)V

    .line 2115
    const/4 v2, 0x0

    invoke-virtual {v1, p0, v2}, Lcom/android/sec_settings/DataUsageSummary$WarningEditorFragment;->setTargetFragment(Landroid/app/Fragment;I)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/sec_settings/DataUsageSummary$WarningEditorFragment;->show(Landroid/app/FragmentManager;Ljava/lang/String;)V
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    .prologue
    .line 2121
    invoke-virtual/range {p0 .. p0}, Lcom/android/sec_settings/DataUsageSummary$WarningEditorFragment;->getActivity()Landroid/app/Activity;

    move-result-object v8

    .line 2122
    .local v8, context:Landroid/content/Context;
    invoke-virtual/range {p0 .. p0}, Lcom/android/sec_settings/DataUsageSummary$WarningEditorFragment;->getTargetFragment()Landroid/app/Fragment;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/sec_settings/DataUsageSummary$WarningEditorFragment;->getArguments()Landroid/os/Bundle;
    ...
    new-instance v1, Lcom/android/sec_settings/DataUsageSummary$WarningEditorFragment$1;

    move-object/from16 v2, p0

    invoke-direct/range {v1 .. v6}, Lcom/android/sec_settings/DataUsageSummary$WarningEditorFragment$1;-><init>(Lcom/android/sec_settings/DataUsageSummary$WarningEditorFragment;Landroid/widget/NumberPicker;Lcom/android/sec_settings/net/NetworkPolicyEditor;Landroid/net/NetworkTemplate;Lcom/android/sec_settings/DataUsageSummary;)V
