.class public Lcom/android/sec_settings/LockScreenSettings;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/sec_settings/LockScreenSettings;->mMotionDialog:Landroid/app/AlertDialog;
    ...
    iput-object v0, p0, Lcom/android/sec_settings/LockScreenSettings;->mInkEffectSummary:[I
...
.method static synthetic access$000(Lcom/android/sec_settings/LockScreenSettings;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 56
    invoke-direct {p0, p1}, Lcom/android/sec_settings/LockScreenSettings;->broadcastMotionChanged(Z)V

    return-void
.end method

.method static synthetic access$100(Lcom/android/sec_settings/LockScreenSettings;)Landroid/preference/SwitchPreferenceScreen;
    .locals 1
    .parameter "x0"

    .prologue
    .line 56
    iget-object v0, p0, Lcom/android/sec_settings/LockScreenSettings;->mCameraShortCut:Landroid/preference/SwitchPreferenceScreen;
...
.method private broadcastMotionChanged(Z)V
    ...
    .line 562
    invoke-virtual {p0}, Lcom/android/sec_settings/LockScreenSettings;->getActivity()Landroid/app/Activity;
...
.method private updateState()V
    ...
    .line 279
    iget-object v7, p0, Lcom/android/sec_settings/LockScreenSettings;->mClock:Landroid/preference/CheckBoxPreference;

    invoke-virtual {p0}, Lcom/android/sec_settings/LockScreenSettings;->getContentResolver()Landroid/content/ContentResolver;
    ...
    .line 287
    iget-object v4, p0, Lcom/android/sec_settings/LockScreenSettings;->mWeather:Landroid/preference/SwitchPreferenceScreen;
    ...
    :cond_0
    :goto_1
    iget-object v7, p0, Lcom/android/sec_settings/LockScreenSettings;->mDualclock:Landroid/preference/SwitchPreferenceScreen;
    ...
    .line 295
    iget-object v4, p0, Lcom/android/sec_settings/LockScreenSettings;->mInformationTicker:Landroid/preference/SwitchPreferenceScreen;

    if-eqz v4, :cond_1

    .line 296
    iget-object v7, p0, Lcom/android/sec_settings/LockScreenSettings;->mInformationTicker:Landroid/preference/SwitchPreferenceScreen;
    ...
    .line 298
    :cond_1
    iget-object v4, p0, Lcom/android/sec_settings/LockScreenSettings;->mCameraShortCut:Landroid/preference/SwitchPreferenceScreen;

    if-eqz v4, :cond_2

    .line 299
    iget-object v7, p0, Lcom/android/sec_settings/LockScreenSettings;->mCameraShortCut:Landroid/preference/SwitchPreferenceScreen;
    ...
    .line 306
    :cond_3
    iget-object v4, p0, Lcom/android/sec_settings/LockScreenSettings;->mRippleEffect:Landroid/preference/CheckBoxPreference;

    invoke-virtual {v4, v6}, Landroid/preference/CheckBoxPreference;->setEnabled(Z)V

    .line 309
    :goto_6
    iget-object v7, p0, Lcom/android/sec_settings/LockScreenSettings;->mRippleEffect:Landroid/preference/CheckBoxPreference;
    ...
    .line 310
    iget-object v4, p0, Lcom/android/sec_settings/LockScreenSettings;->mInkEffect:Landroid/preference/PreferenceScreen;
    ...
    invoke-virtual {p0}, Lcom/android/sec_settings/LockScreenSettings;->getResources()Landroid/content/res/Resources;

    move-result-object v7

    iget-object v8, p0, Lcom/android/sec_settings/LockScreenSettings;->mInkEffectSummary:[I
    ...
    .line 316
    iget-object v4, p0, Lcom/android/sec_settings/LockScreenSettings;->mHelpText:Landroid/preference/CheckBoxPreference;

    if-eqz v4, :cond_6

    .line 317
    iget-object v7, p0, Lcom/android/sec_settings/LockScreenSettings;->mHelpText:Landroid/preference/CheckBoxPreference;
    ...
    .line 319
    :cond_6
    iget-object v4, p0, Lcom/android/sec_settings/LockScreenSettings;->mSayCommand:Landroid/preference/CheckBoxPreference;

    if-eqz v4, :cond_7

    .line 320
    iget-object v7, p0, Lcom/android/sec_settings/LockScreenSettings;->mSayCommand:Landroid/preference/CheckBoxPreference;
    ...
    .line 323
    :cond_7
    iget-object v4, p0, Lcom/android/sec_settings/LockScreenSettings;->mLockScreenShortcut:Landroid/preference/SwitchPreferenceScreen;
...
.method public checkNetwork()Z
    ...
    invoke-virtual {p0, v6}, Lcom/android/sec_settings/LockScreenSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    .line 144
    const v9, 0x7f07003b

    invoke-virtual {p0, v9}, Lcom/android/sec_settings/LockScreenSettings;->addPreferencesFromResource(I)V

    .line 147
    const-string v9, "lock_screen_shortcut"

    invoke-virtual {p0, v9}, Lcom/android/sec_settings/LockScreenSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v9

    check-cast v9, Landroid/preference/SwitchPreferenceScreen;

    iput-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mLockScreenShortcut:Landroid/preference/SwitchPreferenceScreen;

    .line 148
    iget-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mLockScreenShortcut:Landroid/preference/SwitchPreferenceScreen;
    ...
    .line 149
    iget-object v10, p0, Lcom/android/sec_settings/LockScreenSettings;->mLockScreenShortcut:Landroid/preference/SwitchPreferenceScreen;
    ...
    .line 151
    iget-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    .line 155
    :cond_0
    invoke-virtual {p0}, Lcom/android/sec_settings/LockScreenSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    iput-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mClock:Landroid/preference/CheckBoxPreference;

    .line 161
    iget-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mClock:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mWeather:Landroid/preference/SwitchPreferenceScreen;

    .line 164
    iget-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mWeather:Landroid/preference/SwitchPreferenceScreen;
    ...
    iput-boolean v9, p0, Lcom/android/sec_settings/LockScreenSettings;->isWeatherEnabled:Z

    .line 166
    iget-boolean v9, p0, Lcom/android/sec_settings/LockScreenSettings;->isWeatherEnabled:Z
    ...
    iget-object v10, p0, Lcom/android/sec_settings/LockScreenSettings;->mWeather:Landroid/preference/SwitchPreferenceScreen;
    ...
    iput-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mDualclock:Landroid/preference/SwitchPreferenceScreen;

    .line 172
    iget-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mDualclock:Landroid/preference/SwitchPreferenceScreen;
    ...
    iput-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mInformationTicker:Landroid/preference/SwitchPreferenceScreen;

    .line 175
    iget-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mInformationTicker:Landroid/preference/SwitchPreferenceScreen;
    ...
    iget-object v10, p0, Lcom/android/sec_settings/LockScreenSettings;->mInformationTicker:Landroid/preference/SwitchPreferenceScreen;
    ...
    iput-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mCameraShortCut:Landroid/preference/SwitchPreferenceScreen;

    .line 202
    iget-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mCameraShortCut:Landroid/preference/SwitchPreferenceScreen;
    ...
    invoke-static {v9}, Lcom/android/sec_settings/Utils;->isTablet(Landroid/content/Context;)Z
    ...
    iget-object v10, p0, Lcom/android/sec_settings/LockScreenSettings;->mCameraShortCut:Landroid/preference/SwitchPreferenceScreen;
    ...
    iget-object v10, p0, Lcom/android/sec_settings/LockScreenSettings;->mDualclock:Landroid/preference/SwitchPreferenceScreen;
    ...
    iput-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mRippleEffect:Landroid/preference/CheckBoxPreference;
    ...
    :goto_2
    iget-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mRippleEffect:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mInkEffect:Landroid/preference/PreferenceScreen;
    ...
    iput-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mHelpText:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mSayCommand:Landroid/preference/CheckBoxPreference;
    ...
    .line 228
    iget-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mSayCommand:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v10, p0, Lcom/android/sec_settings/LockScreenSettings;->mRippleEffect:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v9, p0, Lcom/android/sec_settings/LockScreenSettings;->mInkEffect:Landroid/preference/PreferenceScreen;
    ...
    iget-object v10, p0, Lcom/android/sec_settings/LockScreenSettings;->mSayCommand:Landroid/preference/CheckBoxPreference;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    invoke-static {v10}, Lcom/android/sec_settings/LockScreenSettings;->AppServiceOn(I)I
    ...
    .line 455
    invoke-direct {p0}, Lcom/android/sec_settings/LockScreenSettings;->updateState()V
    ...
    invoke-static {v10}, Lcom/android/sec_settings/LockScreenSettings;->AppServiceOff(I)I
    ...
    invoke-virtual {p0}, Lcom/android/sec_settings/LockScreenSettings;->checkNetwork()Z
    ...
    invoke-virtual {p0, v1}, Lcom/android/sec_settings/LockScreenSettings;->startActivity(Landroid/content/Intent;)V
    ...
    .line 478
    invoke-static {v6}, Lcom/android/sec_settings/LockScreenSettings;->AppServiceOn(I)I
    ...
    :cond_10
    invoke-static {v6}, Lcom/android/sec_settings/LockScreenSettings;->AppServiceOff(I)I
    ...
    invoke-virtual {p0, v10}, Lcom/android/sec_settings/LockScreenSettings;->setCameraShortCut(Z)V
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 331
    iget-object v4, p0, Lcom/android/sec_settings/LockScreenSettings;->mClock:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v6, p0, Lcom/android/sec_settings/LockScreenSettings;->mClock:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v6, p0, Lcom/android/sec_settings/LockScreenSettings;->mRippleEffect:Landroid/preference/CheckBoxPreference;
    ...
    .line 353
    iget-object v2, p0, Lcom/android/sec_settings/LockScreenSettings;->mInkEffect:Landroid/preference/PreferenceScreen;

    iget-object v3, p0, Lcom/android/sec_settings/LockScreenSettings;->mRippleEffect:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v6, p0, Lcom/android/sec_settings/LockScreenSettings;->mHelpText:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v6, p0, Lcom/android/sec_settings/LockScreenSettings;->mSayCommand:Landroid/preference/CheckBoxPreference;
...
.method public setCameraShortCut(Z)V
    ...
    :cond_1
    iget-object v1, p0, Lcom/android/sec_settings/LockScreenSettings;->mMotionDialog:Landroid/app/AlertDialog;
    ...
    .line 532
    iput-object v4, p0, Lcom/android/sec_settings/LockScreenSettings;->mMotionDialog:Landroid/app/AlertDialog;
    ...
    new-instance v3, Lcom/android/sec_settings/LockScreenSettings$1;

    invoke-direct {v3, p0}, Lcom/android/sec_settings/LockScreenSettings$1;-><init>(Lcom/android/sec_settings/LockScreenSettings;)V
    ...
    iput-object v1, p0, Lcom/android/sec_settings/LockScreenSettings;->mMotionDialog:Landroid/app/AlertDialog;

    .line 548
    iget-object v1, p0, Lcom/android/sec_settings/LockScreenSettings;->mMotionDialog:Landroid/app/AlertDialog;

    new-instance v2, Lcom/android/sec_settings/LockScreenSettings$2;

    invoke-direct {v2, p0}, Lcom/android/sec_settings/LockScreenSettings$2;-><init>(Lcom/android/sec_settings/LockScreenSettings;)V
