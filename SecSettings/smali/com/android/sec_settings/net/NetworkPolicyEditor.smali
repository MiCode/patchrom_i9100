.class public Lcom/android/sec_settings/net/NetworkPolicyEditor;
...
.method public constructor <init>(Landroid/net/NetworkPolicyManager;)V
    ...
    iput-object v0, p0, Lcom/android/sec_settings/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/sec_settings/net/NetworkPolicyEditor;->mPolicyManager:Landroid/net/NetworkPolicyManager;
...
.method private forceMobilePolicyCombined()Z
    ...
    iget-object v5, p0, Lcom/android/sec_settings/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v3, v5}, Lcom/android/sec_settings/net/NetworkPolicyEditor;->setMobilePolicySplitInternal(Ljava/lang/String;Z)Z
...
.method private setMobilePolicySplitInternal(Ljava/lang/String;Z)Z
    ...
    .prologue
    .line 278
    invoke-virtual/range {p0 .. p1}, Lcom/android/sec_settings/net/NetworkPolicyEditor;->isMobilePolicySplit(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v5}, Lcom/android/sec_settings/net/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    invoke-virtual {v0, v1}, Lcom/android/sec_settings/net/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    iget-object v2, v0, Lcom/android/sec_settings/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Lcom/android/sec_settings/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
...
.method public getOrCreatePolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    .prologue
    .line 111
    invoke-virtual {p0, p1}, Lcom/android/sec_settings/net/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    .line 113
    invoke-static {p1}, Lcom/android/sec_settings/net/NetworkPolicyEditor;->buildDefaultPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;

    move-result-object v0

    .line 114
    iget-object v1, p0, Lcom/android/sec_settings/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
...
.method public getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    .prologue
    .line 120
    iget-object v2, p0, Lcom/android/sec_settings/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
...
.method public read()V
    ...
    .line 62
    iget-object v6, p0, Lcom/android/sec_settings/net/NetworkPolicyEditor;->mPolicyManager:Landroid/net/NetworkPolicyManager;
    ...
    .line 65
    .local v3, modified:Z
    iget-object v6, p0, Lcom/android/sec_settings/net/NetworkPolicyEditor;->mPolicies:Ljava/util/ArrayList;
    ...
    :cond_2
    invoke-direct {p0}, Lcom/android/sec_settings/net/NetworkPolicyEditor;->forceMobilePolicyCombined()Z
    ...
    invoke-virtual {p0}, Lcom/android/sec_settings/net/NetworkPolicyEditor;->writeAsync()V
...
.method public setMobilePolicySplit(Ljava/lang/String;Z)V
    ...
    .prologue
    .line 265
    invoke-direct {p0, p1, p2}, Lcom/android/sec_settings/net/NetworkPolicyEditor;->setMobilePolicySplitInternal(Ljava/lang/String;Z)Z
...
.method public setPolicyCycleDay(Landroid/net/NetworkTemplate;ILjava/lang/String;)V
    ...
    .prologue
    .line 156
    invoke-virtual {p0, p1}, Lcom/android/sec_settings/net/NetworkPolicyEditor;->getOrCreatePolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
...
.method public write([Landroid/net/NetworkPolicy;)V
    ...
    .prologue
    .line 102
    iget-object v0, p0, Lcom/android/sec_settings/net/NetworkPolicyEditor;->mPolicyManager:Landroid/net/NetworkPolicyManager;
...
.method public writeAsync()V
    ...
    new-instance v1, Lcom/android/sec_settings/net/NetworkPolicyEditor$1;

    invoke-direct {v1, p0, v0}, Lcom/android/sec_settings/net/NetworkPolicyEditor$1;-><init>(Lcom/android/sec_settings/net/NetworkPolicyEditor;[Landroid/net/NetworkPolicy;)V

    const/4 v2, 0x0

    new-array v2, v2, [Ljava/lang/Void;

    invoke-virtual {v1, v2}, Lcom/android/sec_settings/net/NetworkPolicyEditor$1;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
