.class public Lcom/android/sec_settings/net/UidDetailProvider;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/sec_settings/net/UidDetailProvider;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/android/sec_settings/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;

    .line 41
    return-void
.end method

.method private buildUidDetail(I)Lcom/android/sec_settings/net/UidDetail;
    .locals 13
    .parameter "uid"
    ...
    .line 79
    iget-object v11, p0, Lcom/android/sec_settings/net/UidDetailProvider;->mContext:Landroid/content/Context;
    ...
    new-instance v2, Lcom/android/sec_settings/net/UidDetail;

    invoke-direct {v2}, Lcom/android/sec_settings/net/UidDetail;-><init>()V
    ...
    iput-object v11, v2, Lcom/android/sec_settings/net/UidDetail;->label:Ljava/lang/CharSequence;
    ...
    iput-object v11, v2, Lcom/android/sec_settings/net/UidDetail;->icon:Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    :goto_0
    iget-object v11, v2, Lcom/android/sec_settings/net/UidDetail;->label:Ljava/lang/CharSequence;
    ...
    invoke-static {v1}, Lcom/android/sec_settings/Utils;->getTetheringLabel(Landroid/net/ConnectivityManager;)I
    ...
    iput-object v11, v2, Lcom/android/sec_settings/net/UidDetail;->detailLabels:[Ljava/lang/CharSequence;
    ...
    iget-object v11, v2, Lcom/android/sec_settings/net/UidDetail;->detailLabels:[Ljava/lang/CharSequence;
...
.method public clearCache()V
    ...
    .prologue
    .line 44
    iget-object v1, p0, Lcom/android/sec_settings/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;

    monitor-enter v1

    .line 45
    :try_start_0
    iget-object v0, p0, Lcom/android/sec_settings/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;
...
.method public getUidDetail(IZ)Lcom/android/sec_settings/net/UidDetail;
    .locals 3
    .parameter "uid"
    .parameter "blocking"
    ...
    .prologue
    .line 55
    iget-object v2, p0, Lcom/android/sec_settings/net/UidDetailProvider;->mUidDetailCache:Landroid/util/SparseArray;
    ...
    check-cast v0, Lcom/android/sec_settings/net/UidDetail;

    .line 57
    .local v0, detail:Lcom/android/sec_settings/net/UidDetail;
    monitor-exit v2
    ...
    .line 57
    .end local v0           #detail:Lcom/android/sec_settings/net/UidDetail;
    :catchall_0
    move-exception v1
    ...
    .line 61
    .restart local v0       #detail:Lcom/android/sec_settings/net/UidDetail;
    :cond_0
    if-nez p2, :cond_1
    ...
    .line 65
    :cond_1
    invoke-direct {p0, p1}, Lcom/android/sec_settings/net/UidDetailProvider;->buildUidDetail(I)Lcom/android/sec_settings/net/UidDetail;
