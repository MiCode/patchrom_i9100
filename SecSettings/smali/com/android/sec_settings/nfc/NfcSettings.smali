.class public Lcom/android/sec_settings/nfc/NfcSettings;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v7}, Lcom/android/sec_settings/nfc/NfcSettings;->addPreferencesFromResource(I)V

    .line 46
    invoke-virtual {p0}, Lcom/android/sec_settings/nfc/NfcSettings;->getActivity()Landroid/app/Activity;
    ...
    invoke-virtual {p0, v7}, Lcom/android/sec_settings/nfc/NfcSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    new-instance v7, Lcom/android/sec_settings/nfc/NfcEnabler;

    invoke-direct {v7, v1, v0, v2, v6}, Lcom/android/sec_settings/nfc/NfcEnabler;-><init>(Landroid/content/Context;Landroid/widget/Switch;Landroid/preference/SwitchPreferenceScreen;Landroid/preference/SwitchPreferenceScreen;)V

    iput-object v7, p0, Lcom/android/sec_settings/nfc/NfcSettings;->mNfcEnabler:Lcom/android/sec_settings/nfc/NfcEnabler;
    ...
    invoke-virtual {p0}, Lcom/android/sec_settings/nfc/NfcSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    invoke-direct {v7, v1, v0, v2, v8}, Lcom/android/sec_settings/nfc/NfcEnabler;-><init>(Landroid/content/Context;Landroid/widget/Switch;Landroid/preference/SwitchPreferenceScreen;Landroid/preference/SwitchPreferenceScreen;)V
...
.method public onPause()V
    ...
    .prologue
    .line 79
    iget-object v0, p0, Lcom/android/sec_settings/nfc/NfcSettings;->mNfcEnabler:Lcom/android/sec_settings/nfc/NfcEnabler;
...
.method public onResume()V
    ...
    invoke-virtual {v0}, Lcom/android/sec_settings/nfc/NfcEnabler;->resume()V
