.class public Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceId:I
    ...
    iput-object v0, p0, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->mPreferenceMap:Ljava/util/HashMap;
...
.method private createPreferenceHierarchy()Landroid/preference/PreferenceScreen;
    ...
    .prologue
    .line 131
    invoke-virtual {p0}, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->getPreferenceManager()Landroid/preference/PreferenceManager;

    move-result-object v7

    invoke-virtual {p0}, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->getActivity()Landroid/app/Activity;
    ...
    iget-object v0, p0, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->mKeyboardLayouts:[Landroid/hardware/input/KeyboardLayout;
    ...
    .line 139
    iget-object v7, p0, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->mPreferenceMap:Ljava/util/HashMap;
...
.method private updateCheckedState()V
    ...
    .prologue
    .line 145
    iget-object v3, p0, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->mIm:Landroid/hardware/input/InputManager;

    iget-object v4, p0, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceDescriptor:Ljava/lang/String;
    ...
    .line 149
    iget-object v3, p0, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->mPreferenceMap:Ljava/util/HashMap;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceDescriptor:Ljava/lang/String;

    .line 57
    iget-object v0, p0, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceDescriptor:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/hardware/input/InputManager;

    iput-object v0, p0, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->mIm:Landroid/hardware/input/InputManager;

    .line 62
    iget-object v0, p0, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->mIm:Landroid/hardware/input/InputManager;

    invoke-virtual {v0}, Landroid/hardware/input/InputManager;->getKeyboardLayouts()[Landroid/hardware/input/KeyboardLayout;

    move-result-object v0

    iput-object v0, p0, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->mKeyboardLayouts:[Landroid/hardware/input/KeyboardLayout;
    ...
    .line 64
    invoke-direct {p0}, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->createPreferenceHierarchy()Landroid/preference/PreferenceScreen;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->setPreferenceScreen(Landroid/preference/PreferenceScreen;)V
...
.method public onInputDeviceChanged(I)V
    ...
    .prologue
    .line 118
    iget v0, p0, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceId:I
    ...
    .line 119
    invoke-direct {p0}, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->updateCheckedState()V
...
.method public onResume()V
    ...
    .line 71
    iget-object v1, p0, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->mIm:Landroid/hardware/input/InputManager;
    ...
    iget-object v2, p0, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceDescriptor:Ljava/lang/String;
    ...
    iput v1, p0, Lcom/android/sec_settings/inputmethod/KeyboardLayoutPickerFragment;->mInputDeviceId:I
