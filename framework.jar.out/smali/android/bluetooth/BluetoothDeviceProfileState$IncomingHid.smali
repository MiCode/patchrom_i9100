...
.method public enter()V
    ...
    invoke-static {v2}, Landroid/bluetooth/BluetoothDeviceProfileState;->access$11300(Landroid/bluetooth/BluetoothDeviceProfileState;)Landroid/os/Message;
    ...
    #calls: Landroid/bluetooth/BluetoothDeviceProfileState;->getCurrentMessage()Landroid/os/Message;
    invoke-static {v0}, Landroid/bluetooth/BluetoothDeviceProfileState;->access$11400(Landroid/bluetooth/BluetoothDeviceProfileState;)Landroid/os/Message;
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v2, p1}, Landroid/bluetooth/BluetoothDeviceProfileState;->access$11500(Landroid/bluetooth/BluetoothDeviceProfileState;Landroid/os/Message;)V
    ...
    invoke-static {v4, v3}, Landroid/bluetooth/BluetoothDeviceProfileState;->access$6902(Landroid/bluetooth/BluetoothDeviceProfileState;Z)Z
    ...
    invoke-static {v4, v7, v2}, Landroid/bluetooth/BluetoothDeviceProfileState;->access$7000(Landroid/bluetooth/BluetoothDeviceProfileState;IZ)Z
    ...
    invoke-static {v4}, Landroid/bluetooth/BluetoothDeviceProfileState;->access$6900(Landroid/bluetooth/BluetoothDeviceProfileState;)Z
    ...
    invoke-static {v2}, Landroid/bluetooth/BluetoothDeviceProfileState;->access$7100(Landroid/bluetooth/BluetoothDeviceProfileState;)V
    ...
    #calls: Landroid/bluetooth/BluetoothDeviceProfileState;->deferMessage(Landroid/os/Message;)V
    invoke-static {v2, p1}, Landroid/bluetooth/BluetoothDeviceProfileState;->access$11600(Landroid/bluetooth/BluetoothDeviceProfileState;Landroid/os/Message;)V
    ...
    invoke-static {v2, v4}, Landroid/bluetooth/BluetoothDeviceProfileState;->access$11700(Landroid/bluetooth/BluetoothDeviceProfileState;Lcom/android/internal/util/IState;)V
