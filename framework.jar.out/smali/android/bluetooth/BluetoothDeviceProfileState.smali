...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/server/BluetoothService;Landroid/server/BluetoothA2dpService;Z)V
    ...
    .line 122
    iput v6, p0, Landroid/bluetooth/BluetoothDeviceProfileState;->mHeadsetState:I

    .line 123
    iput v6, p0, Landroid/bluetooth/BluetoothDeviceProfileState;->mA2dpState:I

    .line 125
    iput-boolean v6, p0, Landroid/bluetooth/BluetoothDeviceProfileState;->mConnectionAccessReplyReceived:Z

    .line 129
    iput-boolean v6, p0, Landroid/bluetooth/BluetoothDeviceProfileState;->mPairingRequestRcvd:Z
    ...
    invoke-virtual {p0, v3}, Landroid/bluetooth/BluetoothDeviceProfileState;->addState(Lcom/android/internal/util/State;)V
    ...
    invoke-virtual {p0, v3}, Landroid/bluetooth/BluetoothDeviceProfileState;->setInitialState(Lcom/android/internal/util/State;)V
    ...
    iput-object v3, p0, Landroid/bluetooth/BluetoothDeviceProfileState;->mAdapter:Landroid/bluetooth/BluetoothAdapter;

    .line 258
    iget-object v3, p0, Landroid/bluetooth/BluetoothDeviceProfileState;->mAdapter:Landroid/bluetooth/BluetoothAdapter;

    iget-object v4, p0, Landroid/bluetooth/BluetoothDeviceProfileState;->mContext:Landroid/content/Context;

    iget-object v5, p0, Landroid/bluetooth/BluetoothDeviceProfileState;->mBluetoothProfileServiceListener:Landroid/bluetooth/BluetoothProfile$ServiceListener;

    invoke-virtual {v3, v4, v5, v7}, Landroid/bluetooth/BluetoothAdapter;->getProfileProxy(Landroid/content/Context;Landroid/bluetooth/BluetoothProfile$ServiceListener;I)Z
    ...
    .line 263
    .local v1, m:Landroid/bluetooth/BluetoothDeviceProfileState$MapServiceListener;
    new-instance v3, Landroid/bluetooth/BluetoothDeviceProfileState$PbapServiceListener;

    invoke-direct {v3, p0}, Landroid/bluetooth/BluetoothDeviceProfileState$PbapServiceListener;-><init>(Landroid/bluetooth/BluetoothDeviceProfileState;)V
    ...
    .line 274
    invoke-direct {p0, v7}, Landroid/bluetooth/BluetoothDeviceProfileState;->setTrust(I)V
