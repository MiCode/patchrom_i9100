...
.field public static final MAX:I = 0x44
...
.field public static final TILT:I = 0x43
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/hardware/motion/MREvent;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method public toString()Ljava/lang/String;
    ...
    iget v2, p0, Landroid/hardware/motion/MREvent;->motion:I
    ...
    iget v2, p0, Landroid/hardware/motion/MREvent;->panningDx:I
    ...
    iget v2, p0, Landroid/hardware/motion/MREvent;->panningDy:I
    ...
    iget v2, p0, Landroid/hardware/motion/MREvent;->tilt:I
    ...
    const-string v2, "SNAP_X_POSITIVE"
    ...
    const-string v2, "SNAP_X_NEGATIVE"
    ...
    const-string v2, "SNAP_Y_POSITIVE"
    ...
    const-string v2, "SNAP_Y_NEGATIVE"
    ...
    const-string v2, "SNAP_Z_POSITIVE"
    ...
    const-string v2, "SNAP_Z_NEGATIVE"
    ...
    const-string v2, "SPEAKER_PHONE_ON"
    ...
    const-string v2, "SPEAKER_PHONE_OFF"
    ...
    const-string v2, "FLIP_TOP_TO_BOTTOM"
    ...
    const-string v2, "TILT_PORTRAIT_FRONT"
    ...
    const-string v2, "TILT_PORTRAIT_BACK"
    ...
    const-string v2, "TILT_PORTRAIT_FRONT_BACK_STOP"
    ...
    const-string v2, "TILT_PORTRAIT_LEFT"
    ...
    const-string v2, "TILT_PORTRAIT_RIGHT"
    ...
    const-string v2, "TILT_PORTRAIT_LEFT_RIGHT_STOP"
    ...
    const-string v2, "TILT_LANDSCAPE_LEFT_LEVEL_1"
    ...
    const-string v2, "TILT_LANDSCAPE_LEFT_LEVEL_2"
    ...
    const-string v2, "TILT_LANDSCAPE_RIGHT_LEVEL_1"
    ...
    const-string v2, "TILT_LANDSCAPE_RIGHT_LEVEL_2"
    ...
    const-string v2, "TILT_LANDSCAPE_LEFT_RIGHT_STOP"
    ...
    const-string v2, "TILT_FRONT_BACK_END"
    ...
    const-string v2, "TILT_LEFT_RIGHT_END"
    ...
    const-string v2, "SHORT_SHAKE_START"
    ...
    const-string v2, "SHORT_SHAKE_STOP"
    ...
    const-string v2, "BT_SHARING_RECEIVE_READY"
    ...
    const-string v2, "BT_SHARING_RECEIVE_NOT_READY"
    ...
    const-string v2, "BT_SHARING_SEND_START"
    ...
    const-string v2, "BT_SHARING_SEND_PAUSE"
    ...
    const-string v2, "BT_SHARING_SEND_STOP"
    ...
    const-string v2, "ROTATE_HORIZONTAL"
    ...
    const-string v2, "SNAP1_X_POSITIVE"
    ...
    const-string v2, "SNAP1_X_NEGATIVE"
    ...
    const-string v2, "SNAP1_Y_POSITIVE"
    ...
    const-string v2, "SNAP1_Y_NEGATIVE"
    ...
    const-string v2, "SNAP1_Z_POSITIVE"
    ...
    const-string v2, "SNAP1_Z_NEGATIVE"
    ...
    const-string v2, "SNAP2_X_POSITIVE"
    ...
    const-string v2, "SNAP2_X_NEGATIVE"
    ...
    const-string v2, "SNAP2_Y_POSITIVE"
    ...
    const-string v2, "SNAP2_Y_NEGATIVE"
    ...
    const-string v2, "SNAP2_Z_POSITIVE"
    ...
    const-string v2, "SNAP2_Z_NEGATIVE"
    ...
    const-string v2, "ONE_TAPPING_GYRO"
    ...
    const-string v2, "TWO_TAPPING_GYRO"
    ...
    const-string v2, "ONE_TIPPING_GYRO"
    ...
    const-string v2, "TWO_TIPPING_GYRO"
