...
.method public startActivity(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;[Landroid/net/Uri;ILandroid/os/IBinder;Ljava/lang/String;IZZLjava/lang/String;Landroid/os/ParcelFileDescriptor;Z)I
    ...
    new-instance v21, Landroid/os/StrictMode$ThreadPolicy$Builder;

    move-object/from16 v0, v21

    invoke-direct {v0, v15}, Landroid/os/StrictMode$ThreadPolicy$Builder;-><init>(Landroid/os/StrictMode$ThreadPolicy;)V

    invoke-virtual/range {v21 .. v21}, Landroid/os/StrictMode$ThreadPolicy$Builder;->permitDiskReads()Landroid/os/StrictMode$ThreadPolicy$Builder;

    move-result-object v21

    invoke-virtual/range {v21 .. v21}, Landroid/os/StrictMode$ThreadPolicy$Builder;->build()Landroid/os/StrictMode$ThreadPolicy;
    ...
    invoke-static/range {v21 .. v21}, Landroid/app/enterprise/IRestrictionPolicy$Stub;->asInterface(Landroid/os/IBinder;)Landroid/app/enterprise/IRestrictionPolicy;

    move-result-object v19

    .line 1637
    .local v19, rp:Landroid/app/enterprise/IRestrictionPolicy;
    if-eqz v19, :cond_2
    ...
    .line 1643
    :cond_0
    sget-object v5, Landroid/app/enterprise/RestrictionPolicy;->settingsExceptions:[Ljava/lang/String;
    ...
    .end local v13           #len$:I
    .end local v19           #rp:Landroid/app/enterprise/IRestrictionPolicy;
    :cond_2
    :goto_1
    ...
    .line 1714
    invoke-virtual/range {v17 .. v17}, Landroid/os/Parcel;->readException()V
    ...
    .end local v17           #reply:Landroid/os/Parcel;
    ...
    .restart local v19       #rp:Landroid/app/enterprise/IRestrictionPolicy;
    :cond_3
    ...
    .line 1662
    :try_start_2
    const-string/jumbo v21, "password_policy"

    invoke-static/range {v21 .. v21}, Landroid/os/ServiceManager;->getService(Ljava/lang/String;)Landroid/os/IBinder;

    move-result-object v21

    invoke-static/range {v21 .. v21}, Landroid/app/enterprise/IPasswordPolicy$Stub;->asInterface(Landroid/os/IBinder;)Landroid/app/enterprise/IPasswordPolicy;

    move-result-object v16

    .line 1663
    .local v16, pwdPolicy:Landroid/app/enterprise/IPasswordPolicy;
    if-eqz v16, :cond_2

    invoke-interface/range {v16 .. v16}, Landroid/app/enterprise/IPasswordPolicy;->isChangeRequested()I
    ...
    invoke-interface/range {v21 .. v24}, Landroid/app/IActivityManager;->getTasks(IILandroid/app/IThumbnailReceiver;)Ljava/util/List;
    ...
    .line 1670
    .restart local v4       #activity:Ljava/lang/String;
    sget-object v5, Landroid/app/enterprise/PasswordPolicy;->enforcePwdExceptions:[Ljava/lang/String;
    ...
    .end local v16           #pwdPolicy:Landroid/app/enterprise/IPasswordPolicy;
    ...
    .restart local v17       #reply:Landroid/os/Parcel;
    :cond_9
    const/16 v21, 0x0
