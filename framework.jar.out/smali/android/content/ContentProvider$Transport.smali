...
.method public beginDBTransaction(Ljava/lang/String;)V
    ...
    check-cast v0, Landroid/content/IContentProviderDBAccess;

    invoke-interface {v0, p1}, Landroid/content/IContentProviderDBAccess;->beginDBTransaction(Ljava/lang/String;)V
...
.method public delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;Z)I
    .locals 1
    .parameter "uri"
    .parameter "userWhere"
    .parameter "whereArgs"
    ...
    invoke-interface {v0, p1, p2, p3, p4}, Landroid/content/IContentProviderDBAccess;->delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;Z)I
...
.method public endDBTransaction(Z)V
    .locals 1
    .parameter "isScanningExternalVolume"
    ...
    invoke-interface {v0, p1}, Landroid/content/IContentProviderDBAccess;->endDBTransaction(Z)V
...
.method public getMediaDBSynchronizedObject()Ljava/lang/Object;
    ...
    invoke-interface {v0}, Landroid/content/IContentProviderDBAccess;->getMediaDBSynchronizedObject()Ljava/lang/Object;
...
.method public setDBTransactionSuccessful()V
    ...
    invoke-interface {v0}, Landroid/content/IContentProviderDBAccess;->setDBTransactionSuccessful()V
...
.method public update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;Z)I
    ...
    invoke-interface/range {v0 .. v5}, Landroid/content/IContentProviderDBAccess;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;Z)I
