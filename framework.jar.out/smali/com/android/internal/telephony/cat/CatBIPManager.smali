...
.method private continueProcessingOpenChannel(Landroid/net/NetworkInfo;)V
    ...
    iput-boolean v11, v8, Lcom/android/internal/telephony/cat/CatBIPResponseMessage;->hasAdditionalInfo:Z

    .line 1679
    iget-object v8, p0, Lcom/android/internal/telephony/cat/CatBIPManager;->crnt_resp:Lcom/android/internal/telephony/cat/CatBIPResponseMessage;

    iput v10, v8, Lcom/android/internal/telephony/cat/CatBIPResponseMessage;->AdditionalInfo:I
    ...
    invoke-virtual {v8, v12}, Lcom/android/internal/telephony/cat/CatService;->obtainMessage(I)Landroid/os/Message;
    ...
    .line 1685
    iput-boolean v10, p0, Lcom/android/internal/telephony/cat/CatBIPManager;->resp_pending:Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 740
    :pswitch_0
    const-string v7, "BIP_DATA_STATE_CHANGED"

    invoke-static {p0, v7}, Lcom/android/internal/telephony/cat/CatLog;->d(Ljava/lang/Object;Ljava/lang/String;)V

    .line 741
    iget-object v7, p0, Lcom/android/internal/telephony/cat/CatBIPManager;->mConnectivityListener:Lcom/android/internal/telephony/cat/NetworkConnectivityListener;

    invoke-virtual {v7}, Lcom/android/internal/telephony/cat/NetworkConnectivityListener;->getNetworkInfo()Landroid/net/NetworkInfo;

    move-result-object v7

    iput-object v7, p0, Lcom/android/internal/telephony/cat/CatBIPManager;->nwInfo:Landroid/net/NetworkInfo;

    .line 742
    iget-object v7, p0, Lcom/android/internal/telephony/cat/CatBIPManager;->nwInfo:Landroid/net/NetworkInfo;
    ...
    .line 743
    .local v4, connectionState:Landroid/net/NetworkInfo$State;
    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v8, "nwInfo.getType()  = "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-object v8, p0, Lcom/android/internal/telephony/cat/CatBIPManager;->nwInfo:Landroid/net/NetworkInfo;
    ...
    .line 749
    iget-object v7, p0, Lcom/android/internal/telephony/cat/CatBIPManager;->feature:Ljava/lang/String;

    const-string v8, "enableBIP"
    ...
    const-string v8, "Network :nwInfo.getType() = "
    ...
    const-string v8, " is not TYPE_MOBILE_BIP"
    ...
    .line 757
    iget-boolean v7, p0, Lcom/android/internal/telephony/cat/CatBIPManager;->monitorChannelStatusEvent:Z

    if-ne v7, v10, :cond_4

    .line 758
    iget-object v7, p0, Lcom/android/internal/telephony/cat/CatBIPManager;->connection_list:Ljava/util/ArrayList;
    ...
    .line 776
    .local v1, bipclient:Lcom/android/internal/telephony/cat/CatBIPClientConnection;
    iget-object v7, v1, Lcom/android/internal/telephony/cat/CatBIPConnection;->uiccTerminalIface:Lcom/android/internal/telephony/cat/TransportLevel;

    invoke-virtual {v7}, Lcom/android/internal/telephony/cat/TransportLevel;->isRemoteClient()Z
    ...
    .line 777
    iput-boolean v9, v1, Lcom/android/internal/telephony/cat/CatBIPClientConnection;->isLinkEstablished:Z

    .line 778
    iput-byte v11, v1, Lcom/android/internal/telephony/cat/CatBIPConnection;->linkStateCause:B
    ...
    .end local v1           #bipclient:Lcom/android/internal/telephony/cat/CatBIPClientConnection;
    .end local v5           #i:Ljava/util/Iterator;
    :cond_4
    sget-object v7, Lcom/android/internal/telephony/cat/CatBIPManager;->mCatServicehandle:Lcom/android/internal/telephony/cat/CatService;

    sget-object v7, Lcom/android/internal/telephony/cat/CatService;->mBIPCurrntCmd:Lcom/android/internal/telephony/cat/CommandParams;
    ...
    .line 787
    :cond_5
    const-string v7, "No BIP cmd is being processed, May not have been unregistered from NWConnectivityListener  "
    ...
    .line 792
    .local v3, cmd:Lcom/android/internal/telephony/cat/AppInterface$CommandType;
    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "Still processing "
    ...
    .line 795
    sget-object v7, Lcom/android/internal/telephony/cat/CatBIPManager$2;->$SwitchMap$com$android$internal$telephony$cat$AppInterface$CommandType:[I
    ...
    invoke-direct {p0, v7}, Lcom/android/internal/telephony/cat/CatBIPManager;->continueProcessingOpenChannel(Landroid/net/NetworkInfo;)V
    ...
    invoke-direct {p0, v7}, Lcom/android/internal/telephony/cat/CatBIPManager;->continueProcessingCloseChannel(Landroid/net/NetworkInfo;)V

    goto/16 :goto_0

    .line 811
    .end local v3           #cmd:Lcom/android/internal/telephony/cat/AppInterface$CommandType;
    .end local v4           #connectionState:Landroid/net/NetworkInfo$State;
    :pswitch_3
    const-string v7, "handleMessage: BIP_UICC_SERVER_STARTED"
    ...
    .line 814
    .local v2, bipserver:Lcom/android/internal/telephony/cat/CatBIPServerConnection;
    iget-object v7, v2, Lcom/android/internal/telephony/cat/CatBIPServerConnection;->listener:Ljava/lang/Thread;
    ...
    .line 815
    iget-object v7, v2, Lcom/android/internal/telephony/cat/CatBIPServerConnection;->socket:Ljava/net/Socket;
    ...
    .line 816
    const-string v7, "handleMessage: BIP Server socket closed"

    invoke-static {p0, v7}, Lcom/android/internal/telephony/cat/CatLog;->d(Ljava/lang/Object;Ljava/lang/String;)V

    .line 818
    iput-byte v9, v2, Lcom/android/internal/telephony/cat/CatBIPServerConnection;->linkState:B
    ...
    iput-boolean v10, v7, Lcom/android/internal/telephony/cat/CatBIPResponseMessage;->hasAdditionalInfo:Z

    .line 824
    iget-object v7, p0, Lcom/android/internal/telephony/cat/CatBIPManager;->crnt_resp:Lcom/android/internal/telephony/cat/CatBIPResponseMessage;

    iput v9, v7, Lcom/android/internal/telephony/cat/CatBIPResponseMessage;->AdditionalInfo:I
    ...
    invoke-direct {v8, v2}, Lcom/android/internal/telephony/cat/OpenChannelResponseData;-><init>(Lcom/android/internal/telephony/cat/CatBIPConnection;)V

    iput-object v8, v7, Lcom/android/internal/telephony/cat/CatBIPResponseMessage;->data:Lcom/android/internal/telephony/cat/ResponseData;

    .line 826
    const-string v7, "handleMessage: Filled Open Channel Terminal Response params"
    ...
    invoke-virtual {v7, v12}, Lcom/android/internal/telephony/cat/CatService;->obtainMessage(I)Landroid/os/Message;
    ...
    .line 855
    const-string v7, "handleMessage: Sending OPEN CHANNEL Terminal Response to mCatService handle"
    ...
    .line 829
    .end local v6           #termResp:Landroid/os/Message;
    :cond_8
    const-string v7, "handleMessage: BIP Server socket opened in LISTEN state"

    invoke-static {p0, v7}, Lcom/android/internal/telephony/cat/CatLog;->d(Ljava/lang/Object;Ljava/lang/String;)V

    .line 830
    iput-byte v10, v2, Lcom/android/internal/telephony/cat/CatBIPServerConnection;->linkState:B
    ...
    iget-boolean v7, v2, Lcom/android/internal/telephony/cat/CatBIPConnection;->mBuffsizeModified:Z

    if-ne v7, v10, :cond_9

    sget-object v7, Lcom/android/internal/telephony/cat/ResultCode;->PRFRMD_WITH_MODIFICATION:Lcom/android/internal/telephony/cat/ResultCode;

    :goto_3
    iput-object v7, v8, Lcom/android/internal/telephony/cat/CatBIPResponseMessage;->resCode:Lcom/android/internal/telephony/cat/ResultCode;

    .line 838
    iget-byte v7, v2, Lcom/android/internal/telephony/cat/CatBIPConnection;->linkStateCause:B
    ...
    iput-boolean v9, v7, Lcom/android/internal/telephony/cat/CatBIPResponseMessage;->hasAdditionalInfo:Z
    ...
    iget-byte v8, v2, Lcom/android/internal/telephony/cat/CatBIPConnection;->linkStateCause:B
    ...
    .line 860
    .end local v2           #bipserver:Lcom/android/internal/telephony/cat/CatBIPServerConnection;
    :pswitch_4
    const-string v7, "handleMessage: BIP_UICC_SERVER_RESTART_DONE"
    ...
    .line 863
    .restart local v2       #bipserver:Lcom/android/internal/telephony/cat/CatBIPServerConnection;
    iget-object v7, v2, Lcom/android/internal/telephony/cat/CatBIPServerConnection;->listener:Ljava/lang/Thread;
    ...
    .line 874
    const-string v7, "handleMessage: Filled Terminal Response params"
    ...
    .line 891
    .restart local v6       #termResp:Landroid/os/Message;
    iget-object v7, p0, Lcom/android/internal/telephony/cat/CatBIPManager;->crnt_resp:Lcom/android/internal/telephony/cat/CatBIPResponseMessage;
    ...
    .line 893
    const-string v7, "handleMessage: BIP_UICC_SERVER_RESTART_DONE: Sending Terminal Response to mCatService handle"
