...
.field private mRestrictionPolicy:Landroid/app/enterprise/PhoneRestrictionPolicy;
...
.method private constructor <init>()V
    ...
    .line 179
    iput-object v1, p0, Lcom/android/internal/telephony/CallManager;->mEDM:Landroid/app/enterprise/EnterpriseDeviceManager;

    .line 180
    iput-object v1, p0, Lcom/android/internal/telephony/CallManager;->mRestrictionPolicy:Landroid/app/enterprise/PhoneRestrictionPolicy;
...
.method static synthetic access$100(Lcom/android/internal/telephony/CallManager;)Landroid/app/enterprise/EnterpriseDeviceManager;
    .locals 1
    .parameter "x0"

    .prologue
    .line 63
    iget-object v0, p0, Lcom/android/internal/telephony/CallManager;->mEDM:Landroid/app/enterprise/EnterpriseDeviceManager;

    return-object v0
.end method

.method static synthetic access$102(Lcom/android/internal/telephony/CallManager;Landroid/app/enterprise/EnterpriseDeviceManager;)Landroid/app/enterprise/EnterpriseDeviceManager;
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 63
    iput-object p1, p0, Lcom/android/internal/telephony/CallManager;->mEDM:Landroid/app/enterprise/EnterpriseDeviceManager;

    return-object p1
.end method

.method static synthetic access$200(Lcom/android/internal/telephony/CallManager;)Landroid/app/enterprise/PhoneRestrictionPolicy;
    .locals 1
    .parameter "x0"

    .prologue
    .line 63
    iget-object v0, p0, Lcom/android/internal/telephony/CallManager;->mRestrictionPolicy:Landroid/app/enterprise/PhoneRestrictionPolicy;

    return-object v0
.end method

.method static synthetic access$202(Lcom/android/internal/telephony/CallManager;Landroid/app/enterprise/PhoneRestrictionPolicy;)Landroid/app/enterprise/PhoneRestrictionPolicy;
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 63
    iput-object p1, p0, Lcom/android/internal/telephony/CallManager;->mRestrictionPolicy:Landroid/app/enterprise/PhoneRestrictionPolicy;
...
.method private canDial(Lcom/android/internal/telephony/Phone;)Z
    ...
    const-string/jumbo v10, "serviceState = "
...
.method public acceptCall(Lcom/android/internal/telephony/Call;)V
    ...
    const-string/jumbo v7, "sameChannel:"
...
.method public dial(Lcom/android/internal/telephony/Phone;Ljava/lang/String;)Lcom/android/internal/telephony/Connection;
    ...
    iput-object v8, p0, Lcom/android/internal/telephony/CallManager;->mEDM:Landroid/app/enterprise/EnterpriseDeviceManager;

    .line 765
    iget-object v8, p0, Lcom/android/internal/telephony/CallManager;->mEDM:Landroid/app/enterprise/EnterpriseDeviceManager;
    ...
    iput-object v8, p0, Lcom/android/internal/telephony/CallManager;->mRestrictionPolicy:Landroid/app/enterprise/PhoneRestrictionPolicy;

    .line 769
    :cond_0
    iget-object v8, p0, Lcom/android/internal/telephony/CallManager;->mRestrictionPolicy:Landroid/app/enterprise/PhoneRestrictionPolicy;
    ...
    invoke-virtual {v8, p2}, Landroid/app/enterprise/PhoneRestrictionPolicy;->canOutgoingCall(Ljava/lang/String;)Z
...
.method public dial(Lcom/android/internal/telephony/Phone;Ljava/lang/String;Lcom/android/internal/telephony/UUSInfo;)Lcom/android/internal/telephony/Connection;
    ...
    .line 853
    .local v0, canMakeCall:Z
    const/4 v2, 0x0

    .line 854
    .local v2, isEmergencyCallOnly:Z
    invoke-static {p2}, Landroid/telephony/PhoneNumberUtils;->isEmergencyNumber(Ljava/lang/String;)Z
    ...
    iput-object v4, p0, Lcom/android/internal/telephony/CallManager;->mEDM:Landroid/app/enterprise/EnterpriseDeviceManager;

    .line 858
    iget-object v4, p0, Lcom/android/internal/telephony/CallManager;->mEDM:Landroid/app/enterprise/EnterpriseDeviceManager;
    ...
    iput-object v4, p0, Lcom/android/internal/telephony/CallManager;->mRestrictionPolicy:Landroid/app/enterprise/PhoneRestrictionPolicy;

    .line 862
    :cond_0
    iget-object v4, p0, Lcom/android/internal/telephony/CallManager;->mRestrictionPolicy:Landroid/app/enterprise/PhoneRestrictionPolicy;
    ...
    invoke-virtual {v4, p2}, Landroid/app/enterprise/PhoneRestrictionPolicy;->canOutgoingCall(Ljava/lang/String;)Z
    ...
    invoke-virtual {v4, v7}, Landroid/app/enterprise/PhoneRestrictionPolicy;->getEmergencyCallOnly(Z)Z
    ...
    const-string v6, ", isEmergencyCallOnly="
    ...
    const-string v6, ", isEmergencyNumber="
    ...
    const-string v5, "Admin did not allow dialing this number"
    ...
    const-string v5, "Administrator blocked call on this device"
...
.method public dialVideoCall(Lcom/android/internal/telephony/Phone;Ljava/lang/String;)Lcom/android/internal/telephony/Connection;
    ...
    const-string v3, "basePhone is NULL"
...
.method public setAudioMode()V
    ...
    .line 447
    :cond_2
    const-string/jumbo v5, "realcall=on"
    ...
    .line 405
    :pswitch_0
    iget-boolean v5, p0, Lcom/android/internal/telephony/CallManager;->mPreAcceptCallforAudio:Z
    ...
    const-string v7, "force audio mode to "
    ...
    iput-boolean v5, p0, Lcom/android/internal/telephony/CallManager;->mPreAcceptCallforAudio:Z
    ...
    .line 449
    const-string/jumbo v5, "realcall=off"
