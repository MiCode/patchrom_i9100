.class final enum Landroid/hardware/contextaware/creator/SensorHubRunnerConcreteCreator$SensorHubRunnerList$3;
...
.method protected getRunnerObj()Landroid/hardware/contextaware/ContextProvider;
    ...
    invoke-virtual {p0}, Landroid/hardware/contextaware/creator/SensorHubRunnerConcreteCreator$SensorHubRunnerList$3;->name()Ljava/lang/String;
    ...
    new-instance v2, Landroid/hardware/contextaware/dataprovider/sensorhubprovider/GestureApproachRunner;
    ...
    invoke-direct {v2, v3, v4, v5}, Landroid/hardware/contextaware/dataprovider/sensorhubprovider/GestureApproachRunner;-><init>(Landroid/content/Context;Landroid/os/Looper;Landroid/hardware/contextaware/dataprovider/sensorhubprovider/IAPPowerObservable;)V

    invoke-virtual {v0, v1, v2}, Ljava/util/concurrent/ConcurrentHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 104
    :cond_0
    sget-object v0, Landroid/hardware/contextaware/dataprovider/sensorhubprovider/SensorHubParserProtocol$DATA_TYPE;->LIBRARY_DATATYPE_GESTURE_APPROACH:Landroid/hardware/contextaware/dataprovider/sensorhubprovider/SensorHubParserProtocol$DATA_TYPE;
    ...
    invoke-virtual {p0, v0, v1}, Landroid/hardware/contextaware/creator/SensorHubRunnerConcreteCreator$SensorHubRunnerList$3;->setOption(Ljava/lang/String;Ljava/lang/String;)V
