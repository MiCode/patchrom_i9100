.class final Lcom/android/settings/guide/WifiGuider;
...
.method public showHelpDialog(Z)V
    ...
    iget-object v5, p0, Lcom/android/settings/guide/ListGuiderBase;->mShowedDialog:Lcom/android/settings/guide/ListGuiderBase$GuideStates;

    if-eqz p1, :cond_1

    sget-object v4, Lcom/android/settings/guide/ListGuiderBase$GuideStates;->ON:Lcom/android/settings/guide/ListGuiderBase$GuideStates;
    ...
    .line 36
    :cond_1
    sget-object v4, Lcom/android/settings/guide/ListGuiderBase$GuideStates;->OFF:Lcom/android/settings/guide/ListGuiderBase$GuideStates;
    ...
    invoke-static {v4}, Lcom/android/settings/guide/GuideModeHelper;->switchMode(Landroid/app/Activity;)Z
    ...
    .line 46
    :cond_3
    iget-object v4, p0, Lcom/android/settings/guide/GuiderBase;->mEnabler:Lcom/android/settings/guide/GuideFragment$WrappedEnabler;

    invoke-virtual {v4}, Lcom/android/settings/guide/GuideFragment$WrappedEnabler;->isChecked()Z
    ...
    :goto_2
    iput-object v4, p0, Lcom/android/settings/guide/ListGuiderBase;->mShowedDialog:Lcom/android/settings/guide/ListGuiderBase$GuideStates;
    ...
    new-instance v4, Lcom/android/settings/guide/WifiGuider$1;

    invoke-direct {v4, p0, v1}, Lcom/android/settings/guide/WifiGuider$1;-><init>(Lcom/android/settings/guide/WifiGuider;Landroid/widget/ListView;)V
