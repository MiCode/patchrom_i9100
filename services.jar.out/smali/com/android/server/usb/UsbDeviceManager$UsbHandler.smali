...
.method public constructor <init>(Lcom/android/server/usb/UsbDeviceManager;Landroid/os/Looper;)V
    ...
    invoke-static {p1, v6}, Lcom/android/server/usb/UsbDeviceManager;->access$600(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v6}, Lcom/android/server/usb/UsbDeviceManager;->access$702(Lcom/android/server/usb/UsbDeviceManager;Z)Z
...
.method private isCameraType()Z
    ...
    .line 616
    .local v1, isCameraModel:Ljava/lang/String;
    :try_start_0
    new-instance v3, Ljava/io/File;

    const-string v4, "/system/etc/kies/Kies_Default_Feature.xml"
    ...
    :cond_1
    const-string v3, "<CscFeature_Kies_WifiCategory>"
...
.method private isChargingMode(Ljava/lang/String;)Z
    ...
    #calls: Lcom/android/server/usb/UsbDeviceManager;->containsFunction(Ljava/lang/String;Ljava/lang/String;)Z
    invoke-static {p1, v1}, Lcom/android/server/usb/UsbDeviceManager;->access$800(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private updateAdbNotification()V
    ...
    #getter for: Lcom/android/server/usb/UsbDeviceManager;->mAdbEnabled:Z
    invoke-static {v9}, Lcom/android/server/usb/UsbDeviceManager;->access$700(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    invoke-static {v7}, Lcom/android/server/usb/UsbDeviceManager;->access$1900(Lcom/android/server/usb/UsbDeviceManager;)Landroid/app/NotificationManager;
...
.method private updateUsbNotification()V
    ...
    invoke-static {v7}, Lcom/android/server/usb/UsbDeviceManager;->access$2200(Lcom/android/server/usb/UsbDeviceManager;)Landroid/app/enterprise/RestrictionPolicy;
...
.method private updateUsbState()V
    ...
    invoke-direct {p0}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->isCameraType()Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v9, "handleMessage -> MSG_UPDATE_STATE connected = "
    ...
    const-string v9, "handleMessage -> MSG_ENABLE_ADB = "
    ...
    const-string v8, "handleMessage -> MSG_SET_CURRENT_FUNCTION"
    ...
    :goto_4
    iget-boolean v5, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mPowerConnected:Z
    ...
    const-string v6, "handleMessage -> MSG_SYSTEM_READY"
    ...
    invoke-direct {p0, v5}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->updateUsbCableState(Z)V
    ...
    const-string v7, "handleMessage -> MSG_BOOT_COMPLETED"
    ...
    invoke-static {v5, v6}, Lcom/android/server/usb/UsbDeviceManager;->access$1602(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    #getter for: Lcom/android/server/usb/UsbDeviceManager;->mSettingsManager:Lcom/android/server/usb/UsbSettingsManager;
    invoke-static {v5}, Lcom/android/server/usb/UsbDeviceManager;->access$1700(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbSettingsManager;
    ...
    const-string v7, "handleMessage -> MSG_POWER_STATE = "
    ...
    const-string v7, "handleMessage -> MSG_SAVE_CURRENT_STATE = "
    ...
    .line 773
    iget-object v5, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mUsbDeviceStates:Ljava/util/LinkedHashMap;
    ...
    .line 779
    .local v4, savedfunctions:Ljava/lang/String;
    invoke-static {}, Lcom/android/server/usb/UsbDeviceManager;->access$200()Ljava/lang/String;
    ...
    const-string v8, "handleMessage -> MSG_RESTORE_CURRENT_STATE = "
    ...
    .line 781
    invoke-direct {p0, v4, v7}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->setEnabledFunctions(Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, v4}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->isChargingMode(Ljava/lang/String;)Z
